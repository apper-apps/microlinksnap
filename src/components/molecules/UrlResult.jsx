  ...
  return (
    ...
    <div className="space-y-4">
        <div className="space-y-2">
            <label className="block text-sm font-medium text-gray-700">Your shortened URL
                          </label>
            <div className="flex items-center space-x-3">
                <div
                    className="flex-1 bg-gray-50 border border-gray-200 rounded-lg p-3 font-mono text-primary-600 break-all">
                    {shortUrl}
                </div>
                <Button
                    variant="accent"
    ...
    <div className="bg-gray-50 rounded-lg p-4 space-y-3">
        ...
        <p
            className="text-sm text-gray-600 break-all font-mono bg-white p-2 rounded border">
    ...
    {showQR && <motion.div
        ...
        <div className="qr-container">
            <img src={shortenedLink.qrCode} alt="QR Code" className="w-20 h-20" />
        </div>
        <div className="flex-1">
            <h4 className="font-medium text-gray-900 mb-1">QR Code</h4>
            <p className="text-sm text-gray-600">Scan this QR code to quickly access your shortened URL on mobile devices.
                            </p>
        </div>
</motion.div>}
    
    <div
        className="flex items-center justify-center space-x-4 pt-4 border-t border-gray-200">
        <Button
            variant="outline"
            onClick={onClose}
